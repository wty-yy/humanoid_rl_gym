...
from legged_gym.envs.g1.g1_config import G1Cfg, G1CfgPPO, G1CfgCTS, G1CfgMoECTS, G1TerrainCfg
...
task_registry.register("g1_moe_cts_terrain", G1Robot, G1TerrainCfg(), G1CfgMoECTS())
